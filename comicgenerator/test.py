...
Lily and Max are best friends, and they go to the playground to play on the swings. They are laughing and having a great time when a friendly squirrel comes by and grabs Lily’s hat!
"""
...
# with open(f'{output_folder}/panels.json') as json_file:
