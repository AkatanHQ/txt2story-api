...
ALLOWED_HOSTS = os.getenv("ALLOWED_HOSTS", "").split(",")  # Comma-separated list of hosts
...
class AccessControlMiddleware(BaseHTTPMiddleware):
    async def dispatch(self, request: Request, call_next):
        ...
        if (ALLOWED_IPS and client_ip not in ALLOWED_IPS) or (ALLOWED_HOSTS and host not in ALLOWED_HOSTS):
